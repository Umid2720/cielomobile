                ...
                <div>
                    ...
                    <ul class="lists">
                        <li><span>Voice to Digital Connections</span> that bridge the gap between voice and digital
                            ...
                            contacts.</li>
                        <li><span>Guided Workflows</span> which empower agents with conversational messaging that more
                            efficiently handles higher touch issues. Increasing 1st call resolution and contact center
                            NPS.
                        </li>
                    </ul>
